...
<section class="profile-container">
    ...
    <div class="profile-details">
        ...
        <p><strong>Address:</strong> 123 Main Street, Bengaluru, Karnataka</p>
        <p><strong>Objective:</strong> Aspiring software engineer with a passion for developing innovative programs that expedite the efficiency and effectiveness of organizational success.</p>
...
<section class="education-section">
    ...
    <div class="timeline">
        <div class="timeline-entry">
            ...
            <p>XYZ University, Bengaluru | 2020 - 2024</p>
            <p>CGPA: 8.5/10</p>
        </div>
        <div class="timeline-entry">
            <h3>Higher Secondary Education</h3>
            <p>ABC Pre-University College, Bengaluru | 2018 - 2020</p>
            <p>Percentage: 90%</p>
        </div>
        <div class="timeline-entry">
            <h3>Secondary School Education</h3>
            <p>DEF High School, Bengaluru | 2016 - 2018</p>
            <p>Percentage: 92%</p>
        </div>
    </div>
    ...
    <div id="educationForm" class="education-form">
        ...
        <form method="post" action="/student/add-education">
            <input type="text" name="level" placeholder="Education Level (e.g., Bachelor's)" required>
            <input type="text" name="institution" placeholder="Institution Name" required>
            <input type="text" name="stream" placeholder="Stream (e.g., Computer Science)" required>
            <input type="text" name="grade" placeholder="Grade/CGPA/Percentage" required>
            <input type="text" name="duration" placeholder="Duration (e.g., 2020 - 2024)" required>
