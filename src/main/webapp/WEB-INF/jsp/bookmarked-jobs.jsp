...
<section class="job-listings">
    <c:forEach var="bookmark" items="${bookmarkList}">
        <div class="job-card">
            <h3>${bookmark.job.jobTitle}</h3>
            <p><strong>Company:</strong> ${bookmark.job.companyName}</p>
            <p><strong>Location:</strong> ${bookmark.job.jobLocation}</p>
            <p><strong>Description:</strong> ${bookmark.job.jobDescription}</p>
            <div class="actions">
                <a href="/student/view/${bookmark.job.id}">View</a>
                <a href="/student/apply/${bookmark.job.id}">Apply</a>
                <a href="/student/removeBookmark/${bookmark.job.id}" style="background-color: crimson;">Remove</a>
            </div>
        </div>
    </c:forEach>
</section>
