...
<div class="background-wrapper">
    ...
    <div class="content">
        <section class="hero">
            ...
            <p>Welcome! Please fill out the form below to create your recruiter account.</p>
        </section>

        <div class="form-container">
            <form:form modelAttribute="recruiter" method="post" action="/recruiter/register" enctype="multipart/form-data" id="registrationForm">
                <!-- form fields here -->
